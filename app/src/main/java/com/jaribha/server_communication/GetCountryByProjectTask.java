...
public class GetCountryByProjectTask extends AsyncTask<Void, Void, JSONObject> {
    ...
    public GetCountryByProjectTask(JSONObject jsonObject, GetCountry getCountry) {
    ...
    protected JSONObject doInBackground(Void... params) {
        return new JSONParser().getJsonObjectFromUrl1(Urls.GET_COUNTRIES_BY_PROJECT, jsonObject);
    }
