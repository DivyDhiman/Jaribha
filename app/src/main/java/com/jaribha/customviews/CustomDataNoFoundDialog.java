...
public class CustomDataNoFoundDialog extends Dialog implements View.OnClickListener {
    ...
    public CustomDataNoFoundDialog(Context a, boolean tab) {
        super(a);
        this.c = a;
        this.isTab = tab;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_not_found_dialog_layout);
