...
public class CustomSessionDialog extends Dialog implements View.OnClickListener {
    ...
    public CustomSessionDialog(Context a, boolean tab) {
        super(a);
        this.c = a;
        this.isTab = tab;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.session_dialog_layout);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_dialog:
                ...
                //((Activity) c).overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
                ((Activity) c).finish();
                break;
            default:
                break;
