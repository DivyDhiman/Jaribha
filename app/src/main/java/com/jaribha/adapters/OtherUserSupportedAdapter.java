...
public class OtherUserSupportedAdapter extends ArrayAdapter<GetProjects> {

    List<GetProjects> dataList;
    ItemFilter itemFilter = new ItemFilter();

    public OtherUserSupportedAdapter(Context context, List<GetProjects> objects) {
...
//                break;
        ...
        //((BaseAppCompatActivity) getContext()).displayImage(getContext(), holder.projectImage, sopportedData.image_url, getContext().getResources().getDrawable(R.drawable.server_error_placeholder));
