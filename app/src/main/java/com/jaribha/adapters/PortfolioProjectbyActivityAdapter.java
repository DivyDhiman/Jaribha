...
public class PortfolioProjectbyActivityAdapter extends ArrayAdapter<ActivityData> {

    public PortfolioProjectbyActivityAdapter(Context context, List<ActivityData> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // holder.tv_time_portfolio.setText(activityData.created);

        Date time = Utils.getStringToDate(getContext(), activityData.created);
        holder.tv_time_portfolio.setText(Utils.getTimeSpan(time.getTime()));
        return convertView;
    }
