...
public class MoreInfoQAAdapter extends ArrayAdapter<AddFAQ> {

    public MoreInfoQAAdapter(Context context, List<AddFAQ> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tv_que.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
        viewHolder.tv_que.setText(addFAQ.question);

        viewHolder.tv_ans.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
