...
public class PopularProjectsAdapter extends ArrayAdapter<GetProjects> {

    public ArrayList<Integer> listPosition = new ArrayList<>();
    List<GetProjects> dataList;
    ItemFilter itemFilter = new ItemFilter();

    public PopularProjectsAdapter(Context context, List<GetProjects> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_userN.setText(String.format("%s%s", getContext().getString(R.string.by), ((BaseAppCompatActivity) getContext()).getUser().name));

        holder.tv_location.setText(String.format("%s, %s", creatorsData.city_name, creatorsData.country_name));
        ...
        holder.tv_supported.setText(String.format("%s%%", Utils.getSupportedAmount(creatorsData.total_support_amount, creatorsData.goal)));
        ...
        holder.editLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getContext().startActivity(new Intent(getContext(), EditProjectActivity.class).putExtra(Constants.PROJECT_ID, creatorsData.id));
            }
        });
    ...
    public void dialogWithTwoButton(final GetProjects creatorsData, final int pos) {
        ...
        subTitle.setText(getContext().getString(R.string.delete_project));
