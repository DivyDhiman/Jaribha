...
public class PortfolioProjectbySupportedActivityAdapter extends ArrayAdapter<GetProjects> {

    List<GetProjects> dataList;
    ItemFilter itemFilter = new ItemFilter();

    public PortfolioProjectbySupportedActivityAdapter(Context context, List<GetProjects> objects) {
...
//                break;
        ...
        holder.tv_userN.setText(getContext().getString(R.string.by) + ((BaseAppCompatActivity) getContext()).getUser().name);
        ...
        if (!TextUtils.isNullOrEmpty(sopportedData.total_support_amount) && !TextUtils.isNullOrEmpty(sopportedData.goal)) {
            ...
            holder.tv_supported.setText(String.format("%s%%", Utils.getSupportedAmount(sopportedData.total_support_amount, sopportedData.goal)));
        }
