...
import com.jaribha.adapters.PortfolioProjectbyActivityAdapter;
...
public class PortfolioProjectbyActivityActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    PortfolioProjectbyActivityAdapter activityAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityAdapter = new PortfolioProjectbyActivityAdapter(getActivity(), activityDataArrayList);
