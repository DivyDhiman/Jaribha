...
public class PortfolioProjectbySponseredActivity extends BaseAppCompatActivity implements View.OnClickListener {
...
//        iv_share = (ImageView) findViewById(R.id.iv_share);
        ...
        sponsorsDataArrayList = (ArrayList<GetProjects>) intent.getSerializableExtra(Constants.DATA);

        adapter = new PortfolioProjectbySupportedActivityAdapter(getActivity(), sponsorsDataArrayList);
        ...
        if (tabletSize) {
            ...
            projectGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    intent.putExtra("detail_object", sponsorsDataArrayList.get(position));
                    JaribhaPrefrence.setPref(getActivity(), Constants.PROJECT_TITLE, sponsorsDataArrayList.get(position).title);
                    JaribhaPrefrence.setPref(getActivity(), Constants.PROJECT_ID, sponsorsDataArrayList.get(position).id);
            ...
            btnClosePopup.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    ...
                    if (s.length() != 0) {
                        ...
                        JaribhaPrefrence.setPref(PortfolioProjectbySponseredActivity.this, Constants.SEARCH_TEXT, s.toString().trim());
                    } else {
