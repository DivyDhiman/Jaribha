package com.jaribha.reside_menu;
...
public class ResideMenu extends FrameLayout {
    ...
    private static final int ROTATE_Y_ANGLE = 0;
     ...
     * it will not be able to find default_icon views
     */
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        // and returning true. This behavior is off by default_icon and can be
    ...
    private void setScaleDirection(int direction) {
        ...
        if (direction == DIRECTION_LEFT) {
            ...
            if (tabletSize)
                pivotX = screenWidth * 2.00f;
            else
                pivotX = screenWidth * 3.75f;
    ...
    private AnimatorSet buildScaleDownAnimation(View target, float targetScaleX, float targetScaleY) {
        ...
        scaleDown.playTogether(
                ...
                // ObjectAnimator.ofFloat(target, "scaleX", 0.8f),
                // ObjectAnimator.ofFloat(target, "scaleY", 0.8f)
        );
